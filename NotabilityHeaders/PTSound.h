...
+(id)CreateSoundWithRect:(id)arg1 pos:(id)arg2 icon:(int)arg3 ;
+(id)CreateSoundWithPoint:(id)arg1 pos:(id)arg2 icon:(int)arg3 ;
...
-(id)GetSoundStream;
-(void)SetSoundStream:(id)arg1 ;
-(int)GetIcon;
-(void)SetSoundIconType:(int)arg1 ;
-(void)SetIcon;
-(id)GetIconName;
-(void)SetSoundIconName:(id)arg1 ;
-(id)init;
-(void)dealloc;
@end
