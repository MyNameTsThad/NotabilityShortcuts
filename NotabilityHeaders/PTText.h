...
+(id)CreateTextWithRect:(id)arg1 pos:(id)arg2 contents:(id)arg3 ;
+(id)CreateTextWithPoint:(id)arg1 pos:(id)arg2 contents:(id)arg3 ;
...
-(void)SetTextIconType:(int)arg1 ;
-(void)SetTextIconName:(id)arg1 ;
-(id)GetState;
