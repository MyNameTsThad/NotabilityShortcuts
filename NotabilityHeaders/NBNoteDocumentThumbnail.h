...
@interface NBNoteDocumentThumbnail : NSObject {
...
@property (assign,nonatomic) float rank;                   //@synthesize rank=_rank - In the implementation block
@property (assign,nonatomic) float scale;                  //@synthesize scale=_scale - In the implementation block
-(CGSize)rankIndependentPointSize;
